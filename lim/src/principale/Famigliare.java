...
public class Famigliare {
    ...
    private int id = 1; //1 se famigliare normale,0 per famigliare neutro
    private int malusForza = 0;
    ...
    public Famigliare ( Colore colore, Colore coloreDado, int forzaFami, int id )
    {
        this.colore=colore;
   ...
   /* public void posizionaTorre(AreaTorre area, Torre torre,Famigliare fam){
    ...
    public void posizionaMercato(Famigliare fam,int scegliarea,Giocatore giocatore){
        if(scegliarea == 1){
            mercato.getBonusAreaUno(fam,giocatore);
        }
        if(scegliarea == 2){
            mercato.getBonusAreaDue(fam,giocatore);
        }
        if(scegliarea == 3){
            mercato.getBonusAreaTre(fam,giocatore);
        }
        if(scegliarea == 4){
            ...
            mercato.getBonusPrivi(numeropriv,fam,giocatore);
        }
    }*/
    ...
    public int getForzaFami(){return forzaFami-malusForza;}

    public int getId(){return id;}

    public void setMalusForza(int malus){malusForza = malus;}
